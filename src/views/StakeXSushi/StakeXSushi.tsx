        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
            <StyledInfo>
              ...
              of xSlurry held relative the weight of the staking. xSlurry can be minted
              by staking Slurry. To redeem Slurry staked plus swap fees convert xSlurry
              back to Slurry. {totalSupply ? `There are currently ${getBalanceNumber(totalSupply)} xSUSHI in the whole pool.` : '' }
            </StyledInfo>
          </StyledCardWrapper>
        </StyledCardsWrapper>
        <Spacer size="lg"/>
